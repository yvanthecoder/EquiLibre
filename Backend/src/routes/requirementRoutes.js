...
const { requireTuteurOrAdmin, requireEvaluator, requirePermission } = require('../middlewares/roleCheck');
...
router.patch('/:id/submissions/:submissionId', authenticate, requireEvaluator, updateSubmissionStatus);
